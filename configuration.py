...
class ConfigManager:
    ...
    def update_config_from_gui(self, pdf_dir_input, target_url_input, model_name_input, prompt_input):
        ...
        self.config["model_name"] = model_name_input.text()
        self.config["prompt_template"] = prompt_input.toPlainText()

    def apply_config_to_gui(self, pdf_dir_input, target_url_input, model_name_input, prompt_input):
